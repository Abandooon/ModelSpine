...
[运行入口](src/modelspine_assurance/__init__.py)；从工作区根运行 `python platform/run_tests.py` 或 `python platform/apps/offline.py`，只用标准库。[验收及来源记录](../../../artifacts/audits/modelspine/2026-09-21/README.md)。
